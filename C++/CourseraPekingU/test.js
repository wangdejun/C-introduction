...
OSF.HostSpecificFileVersionMap = {
  ...
  onenote: { web: "16.00", win32: "16.00", winrt: "16.00" },
...
OSF._OfficeAppFactory = (function() {
  ...
  k("Microsoft", window);
  k("Office", Microsoft);
  k("WebExtension", Microsoft.Office);
  ...
  var r = window.location.hash,
    ...
    v = function(f, g) {
      var b = f.split("."),
        ...
        a;
      for (a in b)
        if (parseInt(b[a]) < parseInt(e[a])) return c;
        else if (parseInt(b[a]) > parseInt(e[a])) return d;
      return c;
    },
    t = function() {
      var b = "15.30.1128.0",
    ...
    u = function() {
      ...
      if (!h)
        try {
          ...
          if (typeof agaveHost !== b && agaveHost.GetHostInfo)
            window.external.GetHostInfo = function() {
              return agaveHost.GetHostInfo();
            };
          var m = window.external.GetHostInfo();
          if (m == n) {
            a.isO15 = d;
            a.isDialog = d;
          } else if (
            m.toLowerCase().indexOf("mac") !== -1 &&
            m.toLowerCase().indexOf("outlook") !== -1 &&
            t()
          )
            a.isO15 = d;
          else {
      ...
      var w = function() {
        ...
        k = w();
      if (!h && k && k.getItem(i)) h = k.getItem(i);
      if (h) {
        h = decodeURIComponent(h);
        a.isO15 = c;
        var g = h.split("$");
        if (typeof g[2] == b) g = h.split("|");
        a.hostType = typeof g[0] == b ? f : g[0].toLowerCase();
        a.hostPlatform = typeof g[1] == b ? f : g[1].toLowerCase();
        a.hostSpecificFileVersion = typeof g[2] == b ? f : g[2].toLowerCase();
        a.hostLocale = typeof g[3] == b ? f : g[3].toLowerCase();
        a.osfControlAppCorrelationId = typeof g[4] == b ? f : g[4];
        if (a.osfControlAppCorrelationId == "telemetry")
          a.osfControlAppCorrelationId = f;
        a.isDialog = typeof g[5] != b && g[5] == n ? d : c;
        var v = parseFloat(a.hostSpecificFileVersion),
          o = OSF.HostSpecificFileVersionDefault;
        if (
          OSF.HostSpecificFileVersionMap[a.hostType] &&
          OSF.HostSpecificFileVersionMap[a.hostType][a.hostPlatform]
        )
          o = OSF.HostSpecificFileVersionMap[a.hostType][a.hostPlatform];
        if (v > parseFloat(o)) a.hostSpecificFileVersion = o;
        if (k)
          try {
            k.setItem(i, h);
          } catch (x) {}
    ...
    w = function() {
      ...
      var p = function() {
          ...
          if (
            (typeof Sys !== b &&
              typeof Type !== b &&
              Sys.StringBuilder &&
              typeof Sys.StringBuilder === a &&
              Type.registerNamespace &&
              typeof Type.registerNamespace === a &&
              Type.registerClass &&
              typeof Type.registerClass === a) ||
            (typeof OfficeExt !== b && OfficeExt.MsAjaxError)
          )
            return d;
          else return c;
        },
        ...
        v = function(f) {
          var a = c,
            e = function() {
              if (typeof Strings == b || typeof Strings.OfficeOM == b)
                if (!a) {
                  a = d;
                  var h =
                    k +
        ...
        r = function(c) {
          if (c) {
            h = new OSF.InitializationHelper(a, i, n, x, m);
            a.hostPlatform == "web" &&
              h.saveAndSetDialogInfo &&
              h.saveAndSetDialogInfo(l(j));
            h.setAgaveHostCommunication();
            s(i.wnd, function(b) {
              OSF.AppTelemetry &&
                OSF.AppTelemetry.logAppCommonMessage &&
                OSF.AppTelemetry.logAppCommonMessage(
              ...
              var c = function() {
                ...
                if (b.get_appMinorVersion) {
                  ...
                  if (!d)
                    if (isNaN(b.get_appMinorVersion()))
                      b._appMinorVersion = parseInt(c[1]);
                    else if (c.length > 1 && !isNaN(Number(c[1])))
                      b._appMinorVersion = parseInt(c[1]);
                }
              ...
              c();
              var d = function() {
                h.prepareApiSurface && h.prepareApiSurface(b);
                g.waitForFunction(
                  function() {
                    return (
                      Microsoft.Office.WebExtension.initialize != undefined
                    );
                  },
                  function(a) {
                    if (a) {
                      if (h.prepareApiSurface)
                        Microsoft.Office.WebExtension.initialize(
                          h.getInitializationReason(b)
                        );
                      else h.prepareRightBeforeWebExtensionInitialize(b);
                      h.prepareRightAfterWebExtensionInitialize &&
                        h.prepareRightAfterWebExtensionInitialize();
                    } else
              ...
              !g.isScriptLoading(OSF.ConstantNames.OfficeStringsId) &&
                v(b.get_appUILocale());
              g.waitForScripts([OSF.ConstantNames.OfficeStringsId], function() {
                if (q && !Strings.OfficeOM) Strings.OfficeOM = q;
                h.loadAppSpecificScriptAndCreateOM(b, d, k);
              });
            });
          } else {
            var b = "MicrosoftAjax.js is not loaded successfully.";
            OSF.AppTelemetry &&
              OSF.AppTelemetry.logAppException &&
              OSF.AppTelemetry.logAppException(b);
            throw b;
          }
        },
        w = function() {
          ...
          if (g.isScriptLoading(OSF.ConstantNames.MicrosoftAjaxId))
            g.waitForScripts([OSF.ConstantNames.MicrosoftAjaxId], r);
          else g.waitForFunction(p, r, 500, 100);
        };
      if (a.isO15)
        g.loadScript(
        ...
        t =
          ...
          a.hostPlatform +
          "-" +
          a.hostSpecificFileVersion +
          ".js";
        g.loadScript(k + t.toLowerCase(), OSF.ConstantNames.HostFileId, w);
      }
      a.hostLocale && v(a.hostLocale);
      if (z && !p()) {
        var A =
          (window.location.protocol.toLowerCase() === "https:"
            ? "https:"
            : "http:") + "//ajax.aspnetcdn.com/ajax/3.5/MicrosoftAjax.js";
        g.loadScriptParallel(A, OSF.ConstantNames.MicrosoftAjaxId);
      }
      ...
      var y = a.hostType == "outlook" && a.hostPlatform == "android";
      if (!y) {
  ...
  return {
    ...
    getCachedSessionSettingsKey: function() {
      return (
        (i.conversationID != e ? i.conversationID : o) + "CachedSessionSettings"
      );
    },
